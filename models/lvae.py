...
class LadderVAE(nn.Module):
    ...
    def forward(self, x):
        ...
        output = {
            ...
            'p_params': td_data['p_params'],
            'q_params': td_data['q_params']
        }
        return output
    ...
    def topdown_pass(self,
        ...
        # q params for each layers
        q_params = [None] * self.n_layers

        # p params for each layers
        p_params = [None] * self.n_layers
        ...
        for i in reversed(range(self.n_layers)):
            ...
            q_params[i] = aux['q_params']
            p_params[i] = aux['p_params']
            if self.mode_pred is False:
